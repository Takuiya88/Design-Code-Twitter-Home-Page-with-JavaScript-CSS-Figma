...
class SidebarMoon extends LitElement {
	...
	svgOutline() {
		return html` <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	render() {
		...
		return html` <div @click=${this._switchToggle}>${this.toggle ? this.svgOutline() : this.svgFilled()}</div> `;
	}
